                                ...
                                <div className="flex gap-3">
                                    {colors.map((c) => (
                                        <label key={c} className="relative cursor-pointer">
                                            <input type="radio" name="color" value={c} className="peer sr-only" required defaultChecked={c === colors[0]} />
                                            <div
                                                className="w-8 h-8 rounded-full border-2 border-transparent peer-checked:ring-2 peer-checked:ring-offset-2 peer-checked:ring-[var(--color-brand-navy)] dark:peer-checked:ring-offset-gray-900 transition-all"
